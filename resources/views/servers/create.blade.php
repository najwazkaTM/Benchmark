...
<main class="flex-1 flex justify-center ml-64 p-4 bg-gray-50 overflow-auto">
    <div class="p-4 max-w-l mx-auto"> 
        <!-- Header -->
        <div class="mb-4">
            <h1 class="text-lg font-semibold text-gray-800">Add Source Server</h1>
            <p class="text-xs text-gray-500">Configure a new server for benchmarking</p>
        </div>
        ...
        <div class="bg-white max-w-3xl rounded-lg shadow-md p-4">
            <form method="POST" action="{{ route('servers.store') }}" class="space-y-4">
                ...
                <div class="flex justify-end pt-3 border-t border-gray-100">
                    <button class="px-4 py-1.5 rounded bg-blue-600 text-white text-sm hover:bg-blue-700">
                        Save
                    </button>
                </div>
            </form>
